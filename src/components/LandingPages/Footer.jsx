...
import footerTopImg from "../../assets/footer-top-img.png";
import footerBottomImg from "../../assets/footer-bottom-img.png";
        ...
        <div className="xl:pb-20 xl:pt-32 py-10 lg:w-[80%] w-[90%] mx-auto">
          <div className="grid lg:grid-cols-4 sm:grid-cols-3 grid-cols-2 gap-4">
            ...
            <div class="px-3 md:px-4">
              <p class="new-design-small mb-6 text-white">Company</p>
              <div class="flex flex-col gap-4">
                <a class="text-sm w-fit text-[#828282] opacify-link" href="#">
                  About Us
                </a>
                <a class="text-sm w-fit text-[#828282] opacify-link" href="#">
                  Career
            ...
            <div class="px-3 md:px-4">
              <p class="new-design-small mb-6 text-white">Resources</p>
              <div class="flex flex-col gap-4">
                <a class="text-sm w-fit text-[#828282] opacify-link" href="#">
                  Blog
                </a>
            ...
            <div class="px-3 md:px-4">
              <p class="new-design-small mb-6 text-white">Social</p>
              <div class="flex flex-col gap-4">
                {/* <a
                  class="text-sm w-fit flex items-center gap-2 text-[#828282] opacify-link"
                  href="#"
                >
                  <FaXTwitter /> Twitter
                </a> */}
