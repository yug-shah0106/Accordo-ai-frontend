...
export default defineConfig([
  {
    ...
    rules: {
      ...
      // See LOGGING.md at repo root. Import `logger` from `@/utils/logger`
      // instead of using console.*. error/fatal go to console.error inside the
      // logger wrapper, which is allow-listed there.
      "no-console": "error",
    },
  },
  // Allow console.* in the logger wrapper itself
  {
